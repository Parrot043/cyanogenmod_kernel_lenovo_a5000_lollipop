					...
					const char *_buf, size_t _count)
{
		...
		else if(!strncmp(_buf, "gpw", strlen("gpw")))
	{
		...
		if(p)
		{
			...
			SENSORDB("%s(): set 0x%02x=0x%02x==(0x%02x)\n", __FUNCTION__, reg, val,tmp);
		}
		else
			SENSORDB("%s(): Bad string format input!\n", __FUNCTION__);
	}
...
{   
      ...
      //wm  #if 1
		...
		//iReg+= ((iGain%BASEGAIN)*BASEGAIN)/0X10;
   	    	 if(iReg<=0x10)
   	    	 {
   	    	    	 SP2508MIPI_write_cmos_sensor(0xfd, 0x01);
...
SP2508MIPI_write_cmos_sensor(0x11,0x30); //60//rst num0x30
SP2508MIPI_write_cmos_sensor(0xd0,0x01); //03//disable boost0x01
SP2508MIPI_write_cmos_sensor(0xd1,0x02); //01
SP2508MIPI_write_cmos_sensor(0xd2,0x28); //d0
...
UINT32 SP2508MIPIOpen(void)
{
    ...
    #ifdef SP2508MIPI_USE_OTP
    if(0 == used_otp){
	SENSORDB("[SP2508MIPI_USE_OTP] before update otp wb...........................................\n");
	SENSORDB("[SP2508MIPI_USE_OTP] before update otp wb...........................................\n");
	SENSORDB("[SP2508MIPI_USE_OTP] before update otp wb...........................................\n");
	ret = sp2508_update_otp_wb();

	used_otp =1;
	SENSORDB("[SP2508MIPI_USE_OTP] after update otp wb............................................\n");
	SENSORDB("[SP2508MIPI_USE_OTP] after update otp wb............................................\n");
	SENSORDB("[SP2508MIPI_USE_OTP] after update otp wb............................................\n");
    }
    #endif
